    ...
    <div class="container" style="padding-top: 5px; padding-bottom: 5px;">
        <div class="row">
            ...
            ?>
              ...
              <a href="javascript:;" class="dropdown-toggle Profile-picture" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">
                    
                    <?php
                        if(!$row['Image']){
                            echo '<img alt="" class="img-circle" width="30px;" height = "30px" src="Assets/img/user.png" />';
                        }
                        else{
              ...
              <ul class="dropdown-menu">
                ...
                <li class="li-dropdown" style="padding-top: 3px; padding-bottom: 6px;">
                    <a href="Assets/Ajax Search/Logout.php">
