...
<div class = "font">
<p class="p-signin" style="text-align: right;"> ورود به سایت</p>
</div>
...
<form method = "POST" action = "" class="form-horizontal">
  ...
  <div class="form-group" style="padding-left: 10px;">
      <button type="submit" class="btn-signup-next" data-toggle="tooltip" id = "btn-signin" value = "Lgin here" data-placement="right" title="Insert Email & Password to Sign in">ورود به سایت
...
<div class="form-group text-right" style = "padding-left: 15px; margin-top: 10px;">
      <span class = "empty" style = "display: none; font-size: 18px;"> اسم یوزر و پسورد اشتباه است </span>
      <span class = "incorrect" style = "display: none; color: red; font-size: 18px;"> حانه ها باید پر شود </span>
      <span class = "failed" style = "display: none; font-size: 18px;"> پسورد اشتباه است درست درج نمایید </span>
      <span class = "error" style = "display: none; font-size: 18px;"> اسم یوزر و پسورد مطابقت ندارد </span>
...
<div class = "form_footer">
    <div class="row" style="float: right;">
        ...
        <div class="col-sm-4 text-right">
            <a href = "../Pashto/sign in.php" class="language-signin-Dr"> پښتو </a>
        </div>
...
<br><br>
<!-- <hr style = "width: 100%;"> -->
<label> <a href = "forgot-password.php" > رمز خود را فراموش نموده اید?</a> </label>

<a href = "signup.php" class="create-accountDr text-right"> اکونت ساخته شود </a>
