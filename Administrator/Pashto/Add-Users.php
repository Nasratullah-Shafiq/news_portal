...
<?php 
            if(isset($_POST['submit'])){
                ...
                if(empty($Full_Name) or empty($Username) or empty($Password) or empty($Email) or empty($Gender) or empty($Phone_No) or empty($Image)){
                    $error = "ټول ارقام خانه پری شی";
                    
                }
                else if($Username != $Username_trim){
                    $error = " د یوزر د نوم حروف باید فاصله ونلری";
                }
                else if(mysqli_num_rows($chk_run_user)>0){
                    $error = " د یوزر نوم د مخکی نه موجود دی بل یو و ولیکۍ ";
                }
                else if(mysqli_num_rows($chk_run_email)>0){
                    $error_email = " ایمیل آدرس د مخکی نه موجود دی بل یو ولیکۍ ";
                 }
                else{
                    ...
                    if(mysqli_query($con, $insert_query)){
                        ...
                        $msg = " عملیه په بریالیتوب سرته ورسیده ";

                    }
                    else{
                        $error = " یوزر جوړ نه شو ";
                    }
                }
            }
        ?>
    	...
    	<div class="row" id="row">
            ...
            <div class="row">
                <div calss = "col-md-9" style = "text-align: right;">
                    <h1> <small> د یوزر جوړول </small><i class = "fa fa-user"> </i> </h1><hr>
                    <ol class="breadcrumb">
                        <li class = ""> <a href="Manage-Users.php">  د یوزر مدیریت  <i class = "fa fa-user"></i>  </a></li>
            ...
            <div class="col-md-9 pull-right">
                    <form class="form-horizontal" method="POST" action="" enctype="multipart/form-data">
                      <div class="form-group">
                        <label for="Full Name " class="col-sm-2 text-right pull-right"> نوم </label>
                        <div class="col-sm-10">
                          <input type="text" class="form-control text-right" name="Full_Name" placeholder=" نوم ">
                        </div>
                      </div>
                      <div class="form-group">
                        <label for="Username" class="col-sm-2 text-right pull-right"> د یوزر نوم </label>
                        <div class="col-sm-10">
                          <input type="text" class="form-control text-right" name="Username" placeholder=" د یوزر نوم ">
                        </div>
                      </div>
                      <div class="form-group">
                      ...
                      <div class="form-group">
                          <label for="Language" class="col-sm-2 text-right pull-right"> ژبه </label>
                            <div class="col-sm-10">
                              <select name="Language" class="form-control text-right">
                                <option value="English"> English </option>
                                <option value="Dari"> پښتو</option>
                      ...
                      <div class="form-group">
                        ...
                        <div class="form-group">
                            <label for="Phone No" class="col-sm-2 text-right pull-right"> د اړیکی شمیره </label>
                            <div class="col-sm-10">
                      ...
                      <div class="form-group">
                        ...
                        <div class="form-group">
                            <label for="Profile Picture" class="col-sm-2 text-right pull-right"> انځور </label>
                      ...
                      <div class="form-group">
                        <div class="col-sm-10">
                            <button type="submit" name = "submit" class="button-start-the-quiz pull-right" id = "create-user"> سیستم ته داخل شی </button>
