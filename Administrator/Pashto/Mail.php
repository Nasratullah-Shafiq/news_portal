            ...
            <div class = "col-sm-5 text-right pull-right">
                <form class=" "  method="POST">
                    <div class="form-group">
                        <label> Search Mails Here </label>
                        <div class="input-group input-group-sm">
                            <input type="text" class="form-control" name ="searchMail" id ="searchMail" autocomplete="off" placeholder="Search for Mails... ">
             ...
             <div class="col-md-12" id = "resultMail">
                ...
                <?php while($row = $contact->fetch_array()){ ?>
                    <tr>
                        ...
                        <td> <a href="Delete/DeleteMail.php?del=<?php echo $row['User_ID'];?>" style="color: #D05454;"> <i class = "fa fa-times"></i> Delete </a></td> 
                    </tr>
