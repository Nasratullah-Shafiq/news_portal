    	...
    	<div class="row" id="r">
            ...
            <div class="right-side-bar">
                <div class = "col-md-12" style = "text-align: right;">
                    <h1 style = "color: #2C3E50" class="text-right">  دشبورد  <small> د ارقامو لیدل  <i class = "fa fa-tachometer"> </i></small></h1><hr>
                    <ol class="breadcrumb" class = "text-right">

                        <li class = "activ">  <a href="Add-News.php"> د خبرونو جوړول <i class = "fa fa-list-alt"></i>  </a> </li>
