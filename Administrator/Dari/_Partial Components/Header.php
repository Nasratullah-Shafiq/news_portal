          ...
          <?php } ?>
            ...
            <li class="dropdown dropdown-user" style = " text-align: right;">
                    ...
                    <ul class="dropdown-menu dropdown-menu-default">
                        <li >
                            <a class = "text-right color: red;" href="../index.php" >
                            انگلیسی </a>
                        </li>
                        <li class="divider"> </li>
                        <li>
                        ...
                        <li class="divider"> </li>
                        <li>
                            <a class = "text-right" href="../Pashto/index.php">
                               پښتو </a>
                        </li>
                    </ul>
                </li>
            ...
            <li class="actie"><a id="ahmadsh" href="index.php" style = "color: white;"> صفحه اصلی <i class="fa fa-home"></i></a></li>
                <li><a href="About-Us.php" id="c" style = "color: white;"> در باره ما <i class="fa fa-info"></i></a></li>
                <li><a href="./../../Dari/index.php" style = "color: white;"> بازدید امتحانات <i class="fa fa-list"></i></a></li>
