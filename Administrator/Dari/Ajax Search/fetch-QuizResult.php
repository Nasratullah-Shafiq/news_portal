...
if(mysqli_num_rows($result)>0){
  ...
  while($row = mysqli_fetch_array($result)){
        ...
        $output .='
         <tr>
            ...
            <td> <a href="view-Result.php?id='.$row['User_ID'].'" style="color: #32C5D2;"> view Result </a> </td>
  ...
  echo '<div class="alert alert-danger" role="alert"> Opps!... No Quiz Result Found</div>';
}
